...
Premium brand T-shirts for plus sizes (2XL–7XL), unified pricing, Iraq-wide delivery.
...
- Unified price: **35,000 IQD** per T-shirt
- Sizes: **2XL → 7XL**, each with a weight guide beneath the label
- Cart bulk rule: **10+ pieces → 20% off total + free shipping**, otherwise flat **5,000 IQD** delivery
